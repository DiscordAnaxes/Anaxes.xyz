    ...
    response.json().then(function (data) {
      ...
      var status = `${
        data.data.discord_status === "online"
          ? "<i class='fad fa-circle text-green-500 animate-pulse'></i>"
          : data.data.discord_status === "dnd"
          ? "<i class='fad fa-circle text-red-500 animate-pulse'></i>"
          : data.data.discord_status === "idle"
          ? "<i class='fad fa-circle text-yellow-500 animate-pulse'></i>"
          : "<i class='fad fa-circle text-gray-500 animate-pulse'></i>"
      }`;
